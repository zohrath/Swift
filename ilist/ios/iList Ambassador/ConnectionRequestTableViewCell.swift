...
class ConnectionRequestTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        acceptButton.setTitleColor(Color.ilistBackgroundColor(), for: UIControlState())
        declineButton.setTitleColor(Color.ilistBackgroundColor(), for: UIControlState())
        cancelButton.setTitleColor(Color.ilistBackgroundColor(), for: UIControlState())
