...
class SearchViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        searchViewHolder.backgroundColor = Color.lightGrayColor()
        x.delegate = self
        x.placeholder = NSLocalizedString("SEARCH_USERS_PLACEHOLDER", comment: "")
        x.editingDidChangeBlock = searchTextFieldDidChange
        x.frame = searchViewHolder.bounds
        x.frame.size.height = 64
